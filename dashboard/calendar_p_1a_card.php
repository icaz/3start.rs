...
<small>
    <div class="card card-primary card-outline bg-light">
        <div class="card-body border-top text-center  p-0 m-0">
            <h6><?php echo $danas; ?></h6>
            <table style="text-align:left" id="calendar" class="table table-condensed table-sm table-bordered table-hover">
                <thead>
                    <tr>
                        <th width="40px"></th>
                        <th>
