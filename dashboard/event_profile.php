...
<body class="hold-transition sidebar-mini">
    ...
    if ($mysqli->query($sql)) {
        $result_event = $mysqli->query($sql);
        while ($event_thing = $result_event->fetch_assoc()) {
            $event_id = $event_thing['id'];
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <?php
                            if ($event_no == 0) {
                                include 'add_event_card.php';
                            } elseif ($event_no > 0) {


                                include 'list_event_profiles.php';
                                include 'add_event_card_colapsed.php';
                                // include 'add_event_card_colapsed.php';
                            }
                            ?>
                            <!-- /.widget-user -->
                        ...
                        <div class="col-md-6 text-center">
                            ...
                            <!-- About Me Box -->
                            <?php
                            include 'business_gallery_card.php';
                            ?>
