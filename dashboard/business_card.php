        ...
        <div class="row mb-2 mt-0">
            <div class="col-sm-4 border-right">
                <div class="description-block">
                    <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle bg-light" src="img/sdalon_avatar.png" alt="User profile picture">
                    </div>
                </div>
                <!-- /.description-block -->
            </div>
            <div class="col-sm-8 border-right">
                <div class="description-block mb-0">
                    ...
                    <p class="description-header"><?php echo $address; ?></p>
                    <p class="description-header"><?php echo $phone; ?></p>
                    <div class="row text-center">

                        <div class="col-sm-12 border-top">
                            <small><span class="description-header">Br. Frizera</span></small>
                            <span class="badge badge-danger"><?php //echo $br_frizera; 
                                                                ?></span>
                        </div>
                    </div>
                </div>
