<div class="card card-primary card-outline bg-dark">
    ...
    <div class="card-body border-top">
        <form action="store_event_profile.php?provider_id=<?php echo $provider_id; ?>" method="post">
            <div class="text-center">
                <img class="profile-user-img img-fluid img-circle bg-light" src="img/event.png">
            </div>
            ...
            <div class="card-body border-top text-center bg-dark">
                ...
                <!-- /.row -->
                <hr>
                <button name="btn" value="business_profile" type="submit" class="btn btn-success float-right" disabled><i class="fas fa-plus"></i> &nbsp; dodaj<b>BIZNIS</b></button>
            </div>
