...
$output_now .= '<table class="table table-condensed table-sm">
 <tr align="center">';
...
while ($day_num <= $days_in_month) {
    ...
    $output_now .= '<td class="p-0 m-0" valign="top"><a href="dan.php?dan=' . $year . '-' . $month . '-' . $day_num0 . '" class="btn btn-' . $boja . ' " >' . $day_num0 . '</a></td>';
    $day_num++;
    $day_count++;
