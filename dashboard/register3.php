...
if (isset($_POST['btn']) && $_POST['btn'] == 'user') {
  ...
  if (isset($_POST['email']) && $_POST['email'] != '') {
    ...
    if ($mysqli->query($sql_user)) {
      ...
      if ($result_user->num_rows > 0) {
        $err_mail = '<div class="invalid-feedback">E-mail <u><strong>' . $email . '</strong></u> je već registrovan.</div>';
        ...
        if ($mysqli->query($sql_provider)) {
          ...
          if ($result_provider->num_rows > 0) {
            $err_mail = '<div class="invalid-feedback">E-mail <u><strong>' . $email . '</strong></u> je već registrovan<br>kao provajder.</div>';
            $email_validate = ' is-invalid';
  ...
  if ($email_ok == true && $name_ok == true) {
    ...
    if (strlen($pass) < 2) {
      ...
      $sql = 'INSERT INTO user (name, email, pass, hash)'
    ...
    <div class="card border border-primary">
      <div class="card-body register-card-body rounded">
        ...
        <ul class="nav nav-pills mb-2">
          <li class="nav-item">
            <a class="nav-link active" id="nav-profile-tab" data-toggle="tab" href="#nav-profil" role="tab" aria-controls="nav-profil" aria-selected="true">Profil</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="nav-provider-tab" data-toggle="tab" href="#nav-provider" role="tab" aria-controls="nav-provider" aria-selected="false">provider</a>
          </li>
        </ul>
          ...
          <div class="tab-pane fade show active" id="nav-profil" role="tabpanel" aria-labelledby="nav-home-tab">
            <form action="register.php" method="post">
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-4">
                  <button id="mySubmit" name="btn" value="user" type="submit" class="btn btn-sm btn-primary btn-block">RegistrujSE</button>
                </div>
                <!-- /.col -->
              </div>
            </form>
          </div>
          <div class="tab-pane fade" id="nav-provider" role="tabpanel" aria-labelledby="nav-contact-tab">
            <form action="register_provider.php" method="post">
              <div class="input-group mb-3">
                <input name="name" type="text" class="form-control <?php echo $name_validate; ?>" placeholder="Ime providera" <?php echo $name_value; ?> required autocomplete="off">
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-4">
                  <button id="mySubmit" name="btn" value="provider" type="submit" class="btn btn-sm btn-primary btn-block">RegistrujSE</button>
                </div>
                <!-- /.col -->
              </div>
            </form>
