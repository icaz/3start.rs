...
$output_now .= '<table class="table table-condensed table-sm table-borderless bg-light p=0 m-0">
 <tr align="center">';
$output_now2 .= '<table class="table table-condensed table-sm table-borderless bg-light p=0 m-0">
 <tr align="center">';
...
while ($day_num <= $days_in_month) {
    ...
    $output_now2 .= '<td class="p-0 m-0" valign="top"><a href="dan.php?dan=' . $year . '-' . $month . '-' . $day_num0 . '" class="btn btn-' . $boja . ' btn-xs " >' . $day_num0 . '</a></td>';
    $day_num++;
    $day_count++;
...
<small>
    <div class="card card-primary card-outline bg-light p=0 m-0">
